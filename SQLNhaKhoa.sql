...
VALUES (101, '2022/01/01', N'Ca chiều' );

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (101, '2022/01/03', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (101, '2022/01/05', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (101, '2022/01/07', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (101, '2022/01/09', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (101, '2022/01/11', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (101, '2022/01/13', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/01', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/03', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/05', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/07', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/09', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/11', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (102, '2022/01/13', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/02', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/04', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/06', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/08', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/10', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/12', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (103, '2022/01/14', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/02', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/04', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/06', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/08', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/10', N'Ca chiều');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/12', N'Ca sáng');

INSERT INTO CA_TRUC (MaBS , NgayTruc, CaTruc) 
VALUES (104, '2022/01/14', N'Ca chiều');

                        ----------Bảng BỆNH NHÂN----------
INSERT INTO BENH_NHAN (MaBN, TenBN, NamSinh_BN, GioiTinh_BN, CMND_BN, SĐT_BN, DiaChi_BN, BaoHiem) 
VALUES (201, N'Nguyễn Phương Hằng', '1971/01/26', N'Nữ', 272866551, 0311223344, N'Bình Dương', 'DN574456789147');

INSERT INTO BENH_NHAN (MaBN, TenBN, NamSinh_BN, GioiTinh_BN, CMND_BN, SĐT_BN, DiaChi_BN, BaoHiem) 
VALUES (202, N'Trần Đức Bo', '1999/01/13', N'Nam', 272866513, 0311223344, N'Tp Hồ Chí Minh', 'GD17956789551');
...
INSERT INTO BENH_NHAN (MaBN, TenBN, NamSinh_BN, GioiTinh_BN, CMND_BN, SĐT_BN, DiaChi_BN, BaoHiem) 
VALUES (208, N'Lê Công Duy', '1992/02/02', N'Nam', 272866553, 0311223342, N'Tp Hải Phòng', 'GD131456789369');

INSERT INTO BENH_NHAN (MaBN, TenBN, NamSinh_BN, GioiTinh_BN, CMND_BN, SĐT_BN, DiaChi_BN, BaoHiem) 
VALUES (209, N'Đàm Vĩnh Hưng', '1997/06/19', N'Nam', 272866789, 0311223335, N'Quảng Nam', 'GD149456789147');
...
VALUES (301, 102, 205, N'no' );
                        ...
                        ----------Bảng CHI TIẾT ĐƠN THUỐC----------
INSERT INTO		CHI_TIET_DON_THUOC (MaDT, TenDT, SoLuong, TenDonVi, CachDung, GhiChu) 
...
VALUES (301, N'Amoxicylin', 1, 'gr', N'Sử dụng 1,2gr mỗi 8 giờ', N'Tác dụng phụ');
                        ...
                        ----------Bảng BỆNH ÁN----------
INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap, LichTaikham) 
VALUES (401, 201, 102, '2022/01/01 8:00:00', N'Răng thưa', '2022/01/01 08:05:00', '2022/01/07 14:00:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap, LichTaikham) 
VALUES (402, 202, 101, '2022/01/01 14:00:00', N'Răng hô, vẩu', '2022/01/07 14:05:00', '2022/01/07 08:00:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (403, 203, 103, '2022/01/02 08:00:00', N'Răng sâu', '2022/01/02 08:30:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (404, 204, 104, '2022/01/02 09:00:00', N'Răng bị nhiễm kháng sinh ở mức độ nhẹ', '2022/01/02 09:30:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (405, 206, 101, '2022/01/03 09:00:00', N'Răng nhiễm hóa chất fluor', '2022/01/03 09:30:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, MaDT, NgayKham, KetQua, NgayLap, LichTaikham) 
VALUES (406, 205, 102, 301, '2022/01/03 08:00:00', N'Viêm tủy răng', '2022/01/03 08:05:00', '2022/01/09 08:15:00' );

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap, LichTaikham) 
VALUES (407, 207, 104, '2022/01/04 09:00:00', N'Viêm nha chu răng khôn', '2022/01/04 09:30:00', '2022/01/08 08:00:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (408, 208, 103, '2022/01/04 14:00:00', N'Răng bị sứt mẻ', '2022/01/04 14:30:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (409, 209, 101,  '2022/01/05 14:00:00', N'Răng bị mòn men, đen chân răng', '2022/01/05 14:30:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (410, 210, 102, '2022/01/05 09:00:00', N'Sâu răng', '2022/01/05 09:30:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap) 
VALUES (411, 211, 102, '2022/01/05 10:35:00', N'Sâu răng', '2022/01/05 11:05:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap, LichTaikham) 
VALUES (412, 211, 104, '2022/01/08 09:30:00', N'Răng thưa', '2022/01/08 09:35:00', '2022/01/14 08:00:00');

INSERT INTO BENH_AN (MaBA , MaBN, MaBS, NgayKham, KetQua, NgayLap, LichTaikham) 
VALUES (413, 208, 103, '2022/01/08 14:00:00', N'Răng bị mẻ', '2022/01/08 14:05:00', '2022/01/14 14:00:00');
...
INSERT INTO TIEP_TAN (MaTT, TenTT, NamSinh_TT, GioiTinh_TT, CMND_TT, SĐT_TT, DiaChi_TT) 
VALUES (504, N'Phạm Hoàng Yến', '1999/11/03', N'Nữ', 272859068, 0929650233, N'Vũng Tàu');
...
INSERT INTO HOA_DON (MaHD, MaBN, MaTT, TongTien) 
VALUES (708, 208, 504, 2000000); 

INSERT INTO HOA_DON (MaHD, MaBN, MaTT, TongTien) 
VALUES (709, 209, 501, 4000000); 

INSERT INTO HOA_DON (MaHD, MaBN, MaTT, TongTien) 
VALUES (710, 210, 502, 1000000); 
...
INSERT INTO CHI_TIET_HOA_DON (MaHD, MaDV, DonGia, SoLuong) 
VALUES (708, 608, 500000, 4);

INSERT INTO CHI_TIET_HOA_DON (MaHD, MaDV, DonGia, SoLuong) 
VALUES (709, 608, 500000, 8);

INSERT INTO CHI_TIET_HOA_DON (MaHD, MaDV, DonGia, SoLuong) 
VALUES (710, 608, 500000, 2);

INSERT INTO CHI_TIET_HOA_DON (MaHD, MaDV, DonGia, SoLuong) 
VALUES (711, 608, 500000, 3);

INSERT INTO CHI_TIET_HOA_DON (MaHD, MaDV, DonGia, SoLuong) 
VALUES (712, 601, 3000000, 4);
